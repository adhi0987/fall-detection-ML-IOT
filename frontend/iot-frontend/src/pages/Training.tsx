...
//   prediction: number;
//   timestamp: string;    
//   // Add other features if you want to display them
//   max_Ax: number;
//   mean_Ax: number;
//   max_Ay: number;
//   mean_Ay: number;
...
//       fetchData();
//     } catch (err) {
//       alert('Failed to label data point.');
//       console.error(err);
//     }
//   };
...
//                   <td>
//                     <select className="tag-select" onChange={(e) => handleTagging(item.id, parseInt(e.target.value))}>
